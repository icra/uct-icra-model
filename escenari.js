...
let inf = t5.wwtp;                                                     //influent
let pst = inf.primary_settler(0.005, 42.335, 90.05, 75.125);           //primary settler    function(fw, removal_BPO, removal_UPO, removal_iSS)
let as  = pst.effluent.activated_sludge(16, 8473, 15, 1.0, 'reactor'); //activated sludge   function(T,Vp,Rs,RAS,waste_from)
let cpr = as .effluent.chemical_P_removal(6000, 37, 1.35);             //chemical P removal function(FeCl3_volume, FeCl3_solution, FeCl3_unit_weight)

//console.log(as.effluent.summary);
//console.log(cpr)
