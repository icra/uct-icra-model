...
State_Variables.prototype.reactor=function(Q, T, Vp, SRT){
  //tested (to be reindented back after all is working TODO)
    //inputs
  ...
  //des de dalt fins aqui ok TODO ------------------------
  let TKN_eff = totals.Total_TKN - Ns;       //mg/L as N
  let FSA_eff = TKN_eff - totals.ON[1].usON; //mg/L as N
